    ...
    <div className="min-h-[100dvh] bg-cream flex flex-col items-center justify-center p-6 sm:p-10">
      <div className="w-full max-w-[420px] flex flex-col items-center">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-ink tracking-tight">Iniciá sesión</h1>
          ...
          <SignIn
            ...
            appearance={{
              elements: {
                ...
                header: "hidden",
                formButtonPrimary: "bg-moss hover:bg-forest text-paper transition-colors",
                footer: "bg-transparent",
                socialButtonsBlockButton: "border-line hover:bg-bone transition-colors",
