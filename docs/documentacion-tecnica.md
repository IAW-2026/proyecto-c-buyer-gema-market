# Documentación técnica — Gema Market (Buyer App)

Documento extendido del proyecto. La información necesaria para la corrección está en el [README](../README.md); acá se detallan el stack, las decisiones de arquitectura, el modelo de datos, los contratos de API, la estructura del proyecto y cómo correrlo localmente.
...
### 2.1. Arquitectura por capas (Server-first)
...
### 2.2. Sincronización de usuarios ("Lazy Provisioning")
...
### 2.3. Comunicación inter-servicios y autenticación entre apps
...
### 2.4. Checkout transaccional con rollback (patrón Saga)
...
### 2.5. Control de acceso y panel de administración
...
### 4.1. Endpoints expuestos (consumidos por otras apps)
...
### 4.2. Endpoints administrativos (Etapa 3)
...
### 4.3. Endpoints consumidos (otras apps)
...
> El contrato completo del ecosistema está documentado en [apis.md](apis.md).
